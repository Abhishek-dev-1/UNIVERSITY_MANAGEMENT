...
import javax.swing.*;
 ...
 public abstract class FeeStructure  extends JFrame implements Runnable{
   ...
   JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17;
    ...
    public FeeStructure(){
        ...
        l8 = new JLabel("MTech");
        l8.setBounds(1380,100,100,40);
        l8.setFont(new Font("serif",Font.BOLD,26));
        add(l8);
        
        m9 = new JLabel("81000");
        m9.setBounds(1380,170,150,40);
        m9.setFont(new Font("serif",Font.PLAIN,26));
        add(m9);
        
        m10 = new JLabel("81000");
        m10.setBounds(1380,240,150,40);
        m10.setFont(new Font("serif",Font.PLAIN,26));
        add(m10);
        
        m11 = new JLabel("81000");
        m11.setBounds(1380,310,150,40);
        m11.setFont(new Font("serif",Font.PLAIN,26));
        add(m11);
        
        m12 = new JLabel("81000");
        m12.setBounds(1380,380,150,40);
